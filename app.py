...
<style>
    ...
    .stButton > button { background: #EF4444; color: white; padding: 16px 0; border-radius: 12px; font-size: 18px; font-weight: 700; width: 100%; border: none; }
</style>
...
with st.form("request_form"):
    ...
    budget = st.text_input("Your Budget", placeholder="e.g ₦5,000")

    submitted = st.form_submit_button("📦 Send Request")

if submitted:
    # SHOW LOADING MESSAGE FOR 3 SECONDS
    with st.spinner("Preparing your request... please wait 3 seconds"):
        time.sleep(3)
